...
class Conecte extends CI_Controller {
    ...
    public function login(){
        ...
        $this->form_validation->set_rules('pass_codigo','Codigo','required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->db->where('pass_codigo',$pass_codigo);
            $this->db->limit(1);
	...
	public function painel(){
		...
		if((!$this->session->userdata('session_id')) || (!$this->session->userdata('logado') || ($this->session->userdata('token') != 20540658))){
        	redirect('conecte');
        }
	...
	public function visualizarOs($id = null){
        ...
        $data['emitente'] = $this->tsdc_model->getEmitente();
