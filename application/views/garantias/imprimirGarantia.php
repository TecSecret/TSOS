...
<head>
    <title><?= ($this->lang->line('print_title')) ?></title>
    <meta charset="UTF-8" />
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    <tr>
                                        <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>/emitente">Configurar</a>
                                            <<<</td> </tr> <?php
                                                            } else { ?> <tr>
