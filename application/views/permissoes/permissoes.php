<a href="<?php echo base_url(); ?>/permissoes/adicionar" class="btn btn-success"><i class="fas fa-plus"></i> Adicionar Permissão</a>
            ...
            <tbody>
                <?php 
                    ...
                    foreach ($results as $r) {
                        ...
                        echo '<td>' . $situacao . '</td>';
                        echo '<td>
                                <a href="' . base_url() . '/permissoes/editar/' . $r->idPermissao . '" class="btn btn-info tip-top" title="Editar Permissão"><i class="fas fa-edit"></i></a>
