...
<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'TSOS' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
    ...
    <ul class="nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a title="Meu Perfil" href="<?= site_url('tsos/minhaConta'); ?>"><i class="fas fa-user"></i> <span class="text">Meu Perfil</span></a></li>
          <li class="divider"></li>
