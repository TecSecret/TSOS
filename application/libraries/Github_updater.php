...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the tsos version in the config filename
    ...
    */
    ...
    /**
    * Get tsos current version.
    *
    * @return string Tsos current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting TSOS version from GitHub!');
        }
